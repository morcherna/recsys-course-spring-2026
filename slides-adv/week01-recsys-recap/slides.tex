...
\begin{frame}{Матричные разложения}
\begin{center}
...
8 & Uplift моделирование & \checked  & \checked & \\
...
\item Идеальное выполнение квизов и домашки $96$
\item Качественное заполнение фидбэка $100$
...
\begin{frame}
\begin{center}
\includegraphics[scale=0.3]{images/thankyou.jpg}
\end{center}
\end{frame}
